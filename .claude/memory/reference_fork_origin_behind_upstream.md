...
The fork `origin` (ttraenkler/js2) `main` is **~1185+ commits behind `upstream` (loopdive/js2) `main`** (measured 2026-06-21; grows as upstream advances). PRs target **upstream/main**.
...
gh pr create -R loopdive/js2 --head ttraenkler:<branch> --base main ...
```
