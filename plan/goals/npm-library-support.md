...
| **1312** | Async recursive function (next() compose pattern) — Unhandled rejection | 50 | ready | medium |
| **1313** | await is a passthrough — does not unwrap Promise from async-call expressions | 50 | done | high |
| **1327** | Landing page: per-feature test pass counts + feature report page + playground deep-link | 50 | ready | high |
| **1400** | npm: compile ESLint package entry to valid Wasm | 52 | done | high |
| **1531** | JSX syntax is not parsed when compiling .tsx/.jsx input | 52 | ready | medium |
| **1540** | JSX runtime: bind _jsx/_jsxs/_Fragment as host import (default) and standalone stub | 52 | ready | medium |
...
| **1573** | ESLint next-layer validation-error survey (post #1557 / #1558) | Backlog | ready | high |
| **1575** | Node.js built-in module support — gap survey (js2wasm → npm) | Backlog | ready | high |
| **1576** | React Tier 1 compile/validate survey (probe of `react@19.2.6`) | Backlog | ready | high |
| **1600** | FinalizationRegistry: host-delegate (JS mode) + no-op standalone stub (~12 CEs) | Backlog | ready | low |
