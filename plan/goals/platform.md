...
| **1586** | IR preparation: explicit allocation sites with stable identity and metadata hooks | 55 | in-progress | medium |
| **1587** | Static analysis pass: ownership and access semantics on IR values | 55 | in-progress | medium |
| **1588** | String encoding tracking: prove UTF-8 guarantees for zero-copy Component Model interop | 55 | in-progress | medium |
