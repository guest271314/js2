...
| **779a** | class/dstr method-tramp residual (gen / async-gen / private / static) (~727 fails) | Backlog | ready | high |
...
| **779d** | Object-literal destructuring (non-class, non-for-of) residuals (~132 fails) | Backlog | ready | medium |
| **779e** | arguments-object mapped / trailing-comma / sloppy-strict residuals (~161 fails) | Backlog | ready | medium |
...
| **820d** | class/dstr async-gen-meth default-init `unresolvable` illegal cast | 55 | ready | high |
...
| **1130** | Array methods — getter-observing property access on indices and length | 55 | ready | medium |
