...
clean codegen gap, **independent of the set-like bridge** — filed as **#1673**.
Not a "small cluster" inline fix: needs a host-side super→builtin-prototype
bridge.

### Fail buckets (53) — set-like-consumption semantics → sub-issue #1674
...
shim), so they are filed together as **#1674** rather than split per-method.
