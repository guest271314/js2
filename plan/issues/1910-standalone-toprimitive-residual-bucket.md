...
over-match). **Recommend reopening this issue (or filing a child under goal
`standalone-mode` / umbrella #1781)** to own the 2,835-record residual. Default
lane is healthy here (only 48 records).
