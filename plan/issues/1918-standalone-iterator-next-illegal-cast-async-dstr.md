...
# #1918 — standalone: iterator-protocol `illegal cast` bucket
...
| ~145 | misc: `__obj_find ← __extern_get ← __closure_*`, compound-assignment closures, `__obj_insert ← __defineProperty_value` (the last belongs to #1922) | |
