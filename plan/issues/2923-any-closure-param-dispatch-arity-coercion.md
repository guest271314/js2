---
id: 2923
title: "codegen: dynamic dispatch of an any-typed closure param (fn(...)) must honor JS arity semantics + coerce arg kinds (blocks #2931, unblocks 468+ BigInt tests)"
status: ready
sprint: current
priority: high
horizon: l
...
created: 2026-07-02
updated: 2026-07-02
origin: "2026-07-02 spun out of #2931 yield-gate analysis (dev-callback). origin/main @ 4d5287afc."
---
...
This is the blocker under #2931: the test262 `testWith*TypedArrayConstructors`
...
## Part-1 prototype (from #2931, NOT to ship alone)
...
- Then re-measure the #2931 BigInt corpus: with shim + this fix, sample ~30 and
...
Spun out of #2931 (blocked_on this). Repro scripts were under `.tmp/` during the
#2931 investigation (dyncall / genuine probes); regenerate from the table above.
