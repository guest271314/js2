...
title: "R2: expose structural-reference reverse lookup during Program ABI planning"
status: done
sprint: current
created: 2026-07-30
updated: 2026-07-30
...
R2 still needs exact function-reference carriers for class instructions and
terminal ownership provenance for source globals before the symbolic component
closure can widen production routing.
