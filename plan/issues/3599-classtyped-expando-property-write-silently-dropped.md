...
# #3599 — undeclared property write on a class-typed receiver is silently dropped
...
2. **It invalidates benchmark/conformance comparisons.** Found while benchmarking
   ...
   *same* program and the flat timing curve was an artifact, not a result.
...
- [ ] No test262 regression; check the standalone floor for vacuity movement
      (fixing this may *reveal* previously-vacuous passes — that is expected and
