...
#3750 did — that is what turned a guess into a mechanism there. Do not slice the
work before the profile exists; #3750's first two slicings were both wrong and
