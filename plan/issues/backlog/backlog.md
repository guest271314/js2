...
- [#1767](../1767-native-messaging-64mib-memory-growth.md) — 64 MiB native-messaging stress run now streams continuations without staging the full request; guarded wasmtime 64x array run peaked at 36.1 MiB RSS, PR publish pending (from GitHub #389, 2026-06-01) — high, hard, **in-progress (sprint 58)**
