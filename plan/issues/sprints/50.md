...
|---|---|---|---|
| #1344 | spec gap: Generator/AsyncIterator prototype receiver TypeErrors + return/throw (52 + 12 test262 fails) | medium | blocked |
| #1345 | spec gap: Reflect.* invariant checks mirror internal-method bugs (46 test262 fails as of 2026-05-28) | medium | blocked |
| #1350 | spec gap: ArrayBuffer resizable + TypedArray detached-buffer guards (100 + 39 test262 fails) — DUPLICATE of #1645 | medium | blocked |
| #1633 | spec gap: Array.from / Array.of constructor semantics (39 test262 fails, wasm_compile dominant) | medium | blocked |
| #1640 | spec gap: Reflect.* invariant checks mirror internal-method bugs (47 test262 fails) | medium | blocked |
| #1649 | spec gap: Boolean wrapper + Symbol coercion TypeErrors (24 + 45 test262 fails) | medium | blocked |
...
| #1343 | spec gap: Date.prototype string formatters and parsers (174 of 485 test262 fails) | medium | in-progress |
| #1627 | spec gap: Set methods (union/intersection/etc.) accept any set-like argument (101 test262 fails) | medium | in-progress |
| #1636 | spec gap: JSON.stringify replacer/toJSON/property-list (49 of 66 test262 fails) | medium | in-progress |
...
| Issue | Title | Priority | Status |
|---|---|---|---|
| #1320 | Runtime bridge: Array.from(externref) / Iterator.from(externref) doesn't preserve own [Symbol.iterator] on plain JS objects (4 test262 fails) | medium | in-review |
| #1323 | Iterator protocol bridging: implement $IteratorResult struct in pure Wasm, eliminate host bridge | medium | in-review |
| #1329 | RegExp host-mode: Symbol.replace / replaceAll protocol spec compliance (110 fails) | medium | in-review |
| #1338 | spec gap: Array.from / Array.of constructor semantics (39 test262 fails, wasm_compile dominant) | medium | in-review |
| #1634 | spec gap: AggregateError + SuppressedError errors-iterable + cause coercion (37 test262 fails) | medium | in-review |
| #1638 | spec gap: Date.prototype string formatters and parsers (174 of 485 test262 fails) | medium | in-review |
| #1639 | spec gap: Generator/AsyncIterator prototype receiver TypeErrors + return/throw (52 + 12 test262 fails) | medium | in-review |
| #1641 | spec gap: yield in nested try/finally + yield expression evaluation order (46 test262 fails) | medium | in-review |
| #1643 | spec gap: class static initialization order + private field semantics (significant share of 1500+ class fails) | high | in-review |
| #1645 | spec gap: ArrayBuffer resizable + TypedArray detached-buffer guards (100 + 39 test262 fails) | medium | in-review |
| #1646 | spec gap: Set methods (union/intersection/etc.) accept any set-like argument (101 test262 fails) | medium | in-review |
