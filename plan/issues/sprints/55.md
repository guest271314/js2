...
| Issue | Title | Priority | Status |
|---|---|---|---|
| #1130 | Array methods — getter-observing property access on indices and length | medium | in-review |
| #1598 | host-indep: pure-Wasm String.fromCharCode / fromCodePoint in standalone mode | medium | in-review |
| #1657 | Skip merge_group test262 shards for non-src changes (keep required check green) | medium | in-review |
| #1668 | CI catastrophic-regression guard — block merge-queue on large test262 pass drops |  | in-review |
