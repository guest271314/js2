...
| Item | What | Notes |
|---|---|---|
| #2175 | Host-mode Proxy completion — invariants, Wasm-typed targets, revocation | hard, spec'd; host tracker (renumbered from #2156 — collided with upstream treemap issue) |
...
> #1042 #1373b #1151 #1257 #1694; Proxy #2175 (host, was #2156) #1100 #1355;
...
5. **Lane D (async/Promise)**: host chain #1936 → #1796 landed or in review;
   ...
   / #1694 merged.
6. **Lane E (Proxy)**: #2175 (host) moves toward 100%; #1100 standalone Phase 1
