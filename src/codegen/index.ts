...
function _emitVecAccessExportsInner(ctx: CodegenContext): void {
  ...
  // write-back for the JS-host runtime.
  //
  ...
  // falls back to its previous sidecar-only behaviour. Gated on a defineProperty
  // import being present so modules that never define properties stay
  // byte-identical.
