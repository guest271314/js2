  ...
  if (needLog) {
    ...
    addMathFunc({
      ...
      body: [
        ...
        localGet(2),
        f64c(1.4142135623730951),
        fgt,
        {
          op: "if",
          blockType: { kind: "empty" },
          then: [localGet(2), f64c(0.5), mul, localSet(2), localGet(1), f64c(1), add, localSet(1)],
        } as Instr,
  ...
  if (needed.has("log2")) {
    addMathFunc({
      ...
      body: [
        ...
        f64c(1),
        feq,
        { op: "if", blockType: { kind: "empty" }, then: [localGet(1), ret] } as Instr,
