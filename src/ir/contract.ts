...
//
// ---------------------------------------------------------------------------
// The IR interchange contract — v2.0 surface (#3030-T1/#3520).
//
 ...
 */
export const IR_FORMAT_VERSION = "2.0";
...
export interface IrCoverageEntry {
  ...
  /** Compatibility/reference label while v2 still carries named references. */
