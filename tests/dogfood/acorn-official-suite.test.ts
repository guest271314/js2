// Thin vitest wrapper around the acorn OFFICIAL test suite harness (#3723).
//
...
describe("acorn official test suite harness (#3723)", () => {
  ...
  // requires run-time network (git clone of acorn's test/ source, #3723 —
