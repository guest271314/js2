...
describe("Async function support (synchronous compilation)", () => {
  ...
  // #1728: calling a module-level `const` arrow internally traps with "illegal
  ...
  // the wrap here; the value path is fine). Tracked separately in #1728.
  it.skip("async arrow function (#1728 module-const-arrow dispatch)", async () => {
    const src = `
